...
<Library LVVersion="20008000">
	...
	<Item Name="Support" Type="Folder">
		<Item Name="Create Concrete Message for Method.vi" Type="VI" URL="../Support/Create Concrete Message for Method.vi"/>
		<Item Name="Create Message Class for Method.vi" Type="VI" URL="../Support/Create Message Class for Method.vi"/>
		<Item Name="Get Item Info.vi" Type="VI" URL="../Support/Get Item Info.vi"/>
		<Item Name="Is Actor Public Method.vi" Type="VI" URL="../Support/Is Actor Public Method.vi"/>
		<Item Name="Localized Strings.vi" Type="VI" URL="../Support/Localized Strings.vi"/>
		<Item Name="Validate Item and Invoke Message Creator.vi" Type="VI" URL="../Support/Validate Item and Invoke Message Creator.vi"/>
	</Item>
